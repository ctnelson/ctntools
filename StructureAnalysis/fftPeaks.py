...
def fftPeaks(inim, gaussSigma = 1, subpixelfit=True, thresh=0.1, normalize=True, minRExclusionMethod = 'afterminima', principlePeakMethod = 'first', inax=[None]*3, verbose=False, **kwargs):
    #Inputs
    #inim                     :       input image
